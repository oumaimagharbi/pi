...
import tn.esprit.spring.domain.HttpResponse;
import tn.esprit.spring.domain.User;
import tn.esprit.spring.domain.UserPrincipal;
import tn.esprit.spring.exception.ExceptionHandling;
import tn.esprit.spring.exception.domain.*;
import tn.esprit.spring.service.UserService;
import tn.esprit.spring.utility.JWTTokenProvider;
...
import static tn.esprit.spring.constant.SecurityConstant.JWT_TOKEN_HEADER;
...
public class UserResource extends ExceptionHandling {
    ...
    public ResponseEntity<User> register(@RequestBody User user) throws UserNotFoundException, UsernameExistException, EmailExistException, MessagingException {
        User newUser = userService.register(user.getFirstName(), user.getLastName(), user.getUsername(), user.getEmail(),user.getSex(),user.getEducation_level(),user.getHobbies(),user.getOccupation(),user.getRelationship());
